...
/portals/invest/        OMEGA Invest: community investment / crowdfunding
...
- `cf_*` — OMEGA Invest (community investment). `cf_pledges` is server-
  written only; see `portals/invest/README.md`.
