...
'use strict';
var A = require('./_lib/admin'), B = require('./_lib/buyer-accounts'), brand = require('./_lib/logic-brand');
module.exports = A.handler(async function (req, res) {
  ...
  try {
    ...
    return { org: org, brand: brand(ctx.org), account: { free: true, signup: true }, editorLite: {
