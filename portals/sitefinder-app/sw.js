/* ═══════════════════════════════════════════════════════════════════════════════
   portals/sitefinder-app/sw.js — the Site Finder app's service worker
   ...
   (the Firebase SDK, Firestore, Google Fonts, the ComEd proxy, map tiles) or anything
   under /api/ — sign-in, listings and offers always go to the network. Same-origin
   ...
   Registered by index.html with scope /sitefinder-app (the Vercel rewrite path);
   vercel.json sends Service-Worker-Allowed for this file so that scope is
   permitted from /portals/sitefinder-app/. Same shape as the SkyFund worker: the
   listing catalogue and the circuit reads always go to the network.  ES5.
   ═══════════════════════════════════════════════════════════════════════════════ */
var VERSION = 'sitefinder-app-2026-09-22';
