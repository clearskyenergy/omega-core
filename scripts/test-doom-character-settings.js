...
const context = vm.createContext({el,document:{documentElement:{dataset:{mode:'doom'}}},localStorage:{getItem:k=>saved[k],setItem:(k,v)=>saved[k]=v},OmegaDoom:{create:actor,createMask:actor,createFigure:actor,createPortrait:actor,figures:{rigged:{url:'r'},mask:{url:'m'},ironman:{url:'i'},witchking:{url:'w'},onering:{url:'o'}},credit:k=>k==='mask'?"Doctor Doom's Mask · Nicolas_Laube · CC BY 4.0":k},makeCore:()=>({set(){},say(){},resize(){}}),window:{addEventListener(){}},setMode(){}});
