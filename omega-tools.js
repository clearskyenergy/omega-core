...
(function (global) {
  ...
  /* ══════════════════════════════════════════════════════════════════
     ...
     ══════════════════════════════════════════════════════════════════ */
  var SEED_TOOLS = [
    { key:'editor', name:'Site Map', category:'design',
    ...
    /* SKY FUND — community investment. The sponsor console for a tenant;
  ...
  var OMEGATools = {
    ...
    /* omega-core: alias consumed by omega-tenant.js effectiveTools() */
    catalog: function () { return this._tools.slice(); },
