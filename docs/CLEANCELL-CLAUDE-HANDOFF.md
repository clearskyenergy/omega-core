...
- Live company account for Clean Cell's charging-network customer (not named in the repo): `company_2b06b22951a9dd00659e1c59c676c523cb69474e`, with its email domain on the record (descriptive only), active, free customer account. No customer contact, login or access grant exists because none was supplied.
...
- That customer's office inbox: https://silmarillion.clearskyomega.com/po-inbox?office=1&org=cleancell.us&customerId=company_2b06b22951a9dd00659e1c59c676c523cb69474e
...
- That customer's contact emails are required to assign customer logins. Do not infer membership from an email domain or bypass verification for admin@ addresses.
...
1. Get that customer's named contacts from Clean Cell, then assign logins in its office inbox ("Assign a customer login"). Send nothing automatically.
