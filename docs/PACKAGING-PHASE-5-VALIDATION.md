...
Draft PR (stacked on Phase 4, [#139](https://github.com/clearskyenergy/omega-core/pull/139));
the PR link is recorded in the roadmap status table once opened. Vercel builds
the branch at
`https://omega-core-git-codex-packaging-phase-5-clearsky-usa.vercel.app`.
