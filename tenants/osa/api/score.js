/* ═══════════════════════════════════════════════════════════════════════════
   ...
   THE LIVE ONE IS  /api/score.js  AT THE REPO ROOT.  Fix bugs there.

   This file and the root copy are BYTE-IDENTICAL as of 2026-09-14, so nothing
   is lost either way — but only the root one is reachable.
