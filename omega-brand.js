...
(function (global) {
  ...
  function accessMessage(email, registry) {
    ...
    var dom = defaultDomain(registry);
    /* omega-core: point strangers at the hub, where their own company gets a
       workspace, instead of leaving them at a door that will never open. */
    var hub = cfg().hub ? ' Looking for your own company\'s workspace? Start at ' + cfg().hub + '/start' : '';
    return (dom
      ...
      : ('This account (' + who + ') is not registered to any workspace on this '
         + 'deployment. Contact your administrator for access.')) + hub;
  }
