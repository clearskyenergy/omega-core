...
| 5 · Subscribe in the editor (Step A) | | planned; decision pending | §10.5 says $0 additions within a paid tier activate immediately; clarification requested against the hard pay-first rule before implementing activation. |
