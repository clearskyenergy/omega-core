...
Draft PR [#142](https://github.com/clearskyenergy/omega-core/pull/142),
stacked on Phase 6 ([#141](https://github.com/clearskyenergy/omega-core/pull/141)).
[Vercel preview](https://omega-core-git-codex-packaging-phase-7-clearsky-usa.vercel.app).
