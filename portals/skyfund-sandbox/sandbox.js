window.SKYFUND_DRAFT = {"id":"sample-compute-2","sample":true,"status":"draft","type":"compute","title":"1.5 MW of operating compute capacity · Rockford, IL","tagline":"A container park that is already energised and earning. The partner is selling a share of the hosting revenue from the racks it has spare.","sponsorName":"Northgate Compute","sponsorOrgId":"northgatecompute.com","location":{"city":"Rockford","state":"IL"},"goal":570000,"unitPrice":100,"unitsTotal":5700,"raised":0,"unitsSold":0,"backers":0,"minInvestment":100,"minRaise":300000,"deadline":"2026-11-13T18:19:53.964Z","offer":{"kind":"compute","sharePct":38,"termYears":8,"distributableAnnual":270000,"escalatorPct":2,"degradationPct":0,"codMonths":0,"platformFeePct":3},"sizing":{"kwIt":1500,"racks":36},"perks":[{"id":"p1","title":"Backer","minAmount":100,"desc":"Quarterly distributions and the project update feed."},{"id":"p2","title":"Rack sponsor","minAmount":2500,"desc":"Everything above, plus your name on a rack door and a site visit."}],"story":"Northgate has run this park since 2024: six 250 kW containers on a nine-acre industrial parcel with a 4 MW ComEd service and dark fibre from two carriers. Four containers are leased to a single inference tenant on a three-year take-or-pay. The two the partner added last spring are the subject of this campaign.\n\nThe site is built, energised and earning today, so there is no construction risk in this raise and the first distribution is the quarter after it closes. Investors receive 38% of the distributable cash from the whole park — hosting revenue less power, maintenance and insurance — for eight years. Northgate keeps 62% and continues to operate it.","faq":[{"q":"What is the money used for if the site is already built?","a":"It buys the crowd a share of an operating asset. Northgate recycles the proceeds into the next two containers, which are not part of this offering."},{"q":"What happens if the tenant leaves?","a":"The lease is take-or-pay to 2028. After that the racks are re-let at market, and distributions move with the revenue — they are a share, never a fixed coupon."}],"documents":[{"name":"Offering summary (PDF)","url":"#"},{"name":"Hosting agreement term sheet","url":"#"},{"name":"Twelve months of metered output","url":"#"}],"risks":["Revenue is concentrated in one tenant until the take-or-pay ends in 2028; a re-let below today's rate lowers every distribution after it.","The park is operating, so there is no construction risk in this raise — but no construction contingency either: a container that fails out of warranty is repaired out of distributable cash.","Power is bought at a utility tariff that is not fixed for the term. A tariff increase the hosting rate does not follow reduces the cash the crowd shares in."]};
/* ═══════════════════════════════════════════════════════════════════════════════
...
(function (global) {
  ...
  function offerAdd() {
    ...
    addBar = el('div', 'sb-add', '<img src="/skyfund-sandbox/brand/skyfund-icon-180.png" alt=""><div>' + body + '</div><button class="sb-add-x" type="button" aria-label="Not now">\u00d7</button>');
  ...
  function sponsorControls() {
    ...
    s.querySelector('#sbStore').onclick = function () { location.href = '/skyfund-sandbox'; };
  }
  function controls() {
    ...
    s.querySelector('#sbSponsor').onclick = function () { location.href = '/skyfund-sandbox/sponsor'; };
